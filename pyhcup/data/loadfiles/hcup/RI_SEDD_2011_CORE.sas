...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2011_CORE;                                                        
INFILE 'RI_SEDD_2011_CORE.ASC' LRECL = 544;                                     
...
INPUT                                                                           
      ...
      @341    HCUP_ED                  N2PF.                                    
      @343    HCUP_OS                  N2PF.                                    
      @345    HCUP_SURGERY_BROAD       N2PF.                                    
      @347    HCUP_SURGERY_NARROW      N2PF.                                    
      @349    HISPANIC_X               $CHAR8.                                  
      @357    HOSPBRTH                 N3PF.                                    
      @360    HOSPST                   $CHAR2.                                  
      @362    KEY                      18.                                      
      @380    LOS                      N5PF.                                    
      ...
      @472    PSTCO                    N5PF.                                    
      @477    PSTCO2                   N5PF.                                    
      @482    PointOfOriginUB04        $CHAR1.                                  
      @483    PointOfOrigin_X          $CHAR1.                                  
      @484    RACE                     N2PF.                                    
      @486    RACE_X                   $CHAR8.                                  
      @494    STATE_AS                 N2PF.                                    
      @496    STATE_ED                 N2PF.                                    
