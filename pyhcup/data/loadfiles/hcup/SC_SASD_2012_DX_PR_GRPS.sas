...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SASDC_2012_DX_PR_GRPS;                                                  
INFILE 'SC_SASD_2012_DX_PR_GRPS.ASC' LRECL = 445;                               
...
INPUT                                                                           
      ...
      @239    INJURY                   N2PF.                                    
      @241    INJURY_CUT               N2PF.                                    
      @243    INJURY_DROWN             N2PF.                                    
      @245    INJURY_FALL              N2PF.                                    
      @247    INJURY_FIRE              N2PF.                                    
      @249    INJURY_FIREARM           N2PF.                                    
      @251    INJURY_MACHINERY         N2PF.                                    
      @253    INJURY_MVT               N2PF.                                    
      @255    INJURY_NATURE            N2PF.                                    
      @257    INJURY_POISON            N2PF.                                    
      @259    INJURY_STRUCK            N2PF.                                    
      @261    INJURY_SUFFOCATION       N2PF.                                    
      @263    INTENT_ASSAULT           N2PF.                                    
      @265    INTENT_SELF_HARM         N2PF.                                    
      @267    INTENT_UNINTENTIONAL     N2PF.                                    
      @269    KEY                      15.                                      
      @284    MULTINJURY               N2PF.                                    
      @286    PCLASS1                  N2PF.                                    
      @288    PCLASS2                  N2PF.                                    
      ...
      @420    U_NEWBN4L                N2PF.                                    
      @422    U_NUCMED                 N2PF.                                    
      @424    U_OBSERVATION            N2PF.                                    
      @426    U_OCCTHERAPY             N2PF.                                    
      @428    U_ORGANACQ               N2PF.                                    
      @430    U_OTHIMPLANTS            N2PF.                                    
      @432    U_PACEMAKER              N2PF.                                    
      @434    U_PHYTHERAPY             N2PF.                                    
      @436    U_RADTHERAPY             N2PF.                                    
      @438    U_RESPTHERAPY            N2PF.                                    
      @440    U_SPEECHTHERAPY          N2PF.                                    
      @442    U_STRESS                 N2PF.                                    
      @444    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
