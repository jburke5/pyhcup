...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SASDC_2007_CORE;                                                        
INFILE 'NJ_SASD_2007_CORE.ASC' LRECL = 470;                                     
...
INPUT                                                                           
      ...
      @407    PSTCO                    N5PF.                                    
      @412    PSTCO2                   N5PF.                                    
      @417    PointOfOriginUB04        $CHAR1.                                  
      @418    PointOfOrigin_X          $CHAR1.                                  
      @419    RACE                     N2PF.                                    
      @421    RACE_X                   $CHAR1.                                  
      @422    READMIT                  N2PF.                                    
      @424    STATE_AS                 N2PF.                                    
