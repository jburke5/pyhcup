...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SASDC_2012_DX_PR_GRPS;                                                  
INFILE 'IA_SASD_2012_DX_PR_GRPS.ASC' LRECL = 915;                               
...
INPUT                                                                           
      ...
      @809    INJURY                   N2PF.                                    
      @811    INJURY_CUT               N2PF.                                    
      @813    INJURY_DROWN             N2PF.                                    
      @815    INJURY_FALL              N2PF.                                    
      @817    INJURY_FIRE              N2PF.                                    
      @819    INJURY_FIREARM           N2PF.                                    
      @821    INJURY_MACHINERY         N2PF.                                    
      @823    INJURY_MVT               N2PF.                                    
      @825    INJURY_NATURE            N2PF.                                    
      @827    INJURY_POISON            N2PF.                                    
      @829    INJURY_STRUCK            N2PF.                                    
      @831    INJURY_SUFFOCATION       N2PF.                                    
      @833    INTENT_ASSAULT           N2PF.                                    
      @835    INTENT_SELF_HARM         N2PF.                                    
      @837    INTENT_UNINTENTIONAL     N2PF.                                    
      @839    KEY                      15.                                      
      @854    MULTINJURY               N2PF.                                    
      @856    U_BLOOD                  N2PF.                                    
      @858    U_CATH                   N2PF.                                    
      @860    U_CCU                    N2PF.                                    
      @862    U_CHESTXRAY              N2PF.                                    
      @864    U_CTSCAN                 N2PF.                                    
      @866    U_DIALYSIS               N2PF.                                    
      @868    U_ECHO                   N2PF.                                    
      @870    U_ED                     N2PF.                                    
      ...
      @890    U_NEWBN4L                N2PF.                                    
      @892    U_NUCMED                 N2PF.                                    
      @894    U_OBSERVATION            N2PF.                                    
      @896    U_OCCTHERAPY             N2PF.                                    
      @898    U_ORGANACQ               N2PF.                                    
      @900    U_OTHIMPLANTS            N2PF.                                    
      @902    U_PACEMAKER              N2PF.                                    
      @904    U_PHYTHERAPY             N2PF.                                    
      @906    U_RADTHERAPY             N2PF.                                    
      @908    U_RESPTHERAPY            N2PF.                                    
      @910    U_SPEECHTHERAPY          N2PF.                                    
      @912    U_STRESS                 N2PF.                                    
