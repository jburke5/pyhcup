...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SASDC_2011_CORE;                                                        
INFILE 'OR_SASD_2011_CORE.ASC' LRECL = 469;                                     
...
INPUT                                                                           
      ...
      @217    DXCCS9                   N4PF.                                    
      @221    DXCCS10                  N4PF.                                    
      @225    DX_Visit_Reason1         $CHAR5.                                  
      @230    DX_Visit_Reason2         $CHAR5.                                  
      @235    DX_Visit_Reason3         $CHAR5.                                  
      @240    ECODE1                   $CHAR5.                                  
      @245    ECODE2                   $CHAR5.                                  
      @250    ECODE3                   $CHAR5.                                  
      @255    ECODE4                   $CHAR5.                                  
      ...
      @287    HCUP_ED                  N2PF.                                    
      @289    HCUP_OS                  N2PF.                                    
      @291    HCUP_SURGERY_BROAD       N2PF.                                    
      @293    HCUP_SURGERY_NARROW      N2PF.                                    
      @295    HISPANIC_X               $CHAR2.                                  
      @297    HOSPBRTH                 N3PF.                                    
      @300    HOSPST                   $CHAR2.                                  
      @302    KEY                      18.                                      
      @320    LOS                      N5PF.                                    
      ...
      @388    PL_RUCA2005              N4P1F.                                   
      @392    PL_RUCA4_2005            N2PF.                                    
      @394    PL_RUCC2003              N2PF.                                    
      @396    PL_UIC2003               N2PF.                                    
      @398    PL_UR_CAT4               N2PF.                                    
      @400    PROCTYPE                 N3PF.                                    
      @403    PSTATE                   $CHAR2.                                  
      @405    PointOfOriginUB04        $CHAR1.                                  
      @406    PointOfOrigin_X          $CHAR2.                                  
      @408    RACE                     N2PF.                                    
      @410    RACE_X                   $CHAR2.                                  
      @412    STATE_AS                 N2PF.                                    
      @414    STATE_ED                 N2PF.                                    
