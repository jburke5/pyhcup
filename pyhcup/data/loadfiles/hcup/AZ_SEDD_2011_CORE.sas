...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2011_CORE;                                                        
INFILE 'AZ_SEDD_2011_CORE.ASC' LRECL = 912;                                     
...
INPUT                                                                           
      ...
      @487    HCUP_ED                  N2PF.                                    
      @489    HCUP_OS                  N2PF.                                    
      @491    HCUP_SURGERY_BROAD       N2PF.                                    
      @493    HCUP_SURGERY_NARROW      N2PF.                                    
      @495    HOSPBRTH                 N3PF.                                    
      @498    HOSPST                   $CHAR2.                                  
      @500    HOSP_NPI                 $CHAR10.                                 
      @510    Homeless                 N2PF.                                    
      ...
      @603    PL_CBSA                  N3PF.                                    
      @606    PL_MSA1993               N3PF.                                    
      @609    PL_NCHS2006              N2PF.                                    
      @611    PL_RUCA10_2005           N2PF.                                    
      @613    PL_RUCA2005              N4P1F.                                   
      @617    PL_RUCA4_2005            N2PF.                                    
      @619    PL_RUCC2003              N2PF.                                    
      @621    PL_UIC2003               N2PF.                                    
      @623    PL_UR_CAT4               N2PF.                                    
      @625    PR1                      $CHAR4.                                  
      @629    PR2                      $CHAR4.                                  
      ...
      @772    PSTATE                   $CHAR2.                                  
      @774    PSTCO2                   N5PF.                                    
      @779    PointOfOriginUB04        $CHAR1.                                  
      @780    PointOfOrigin_X          $CHAR1.                                  
      @781    RACE                     N2PF.                                    
      @783    RACE_X                   $CHAR4.                                  
      @787    SPLIT_IPED               N2PF.                                    
      @789    STATE_AS                 N2PF.                                    
