...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SASDC_2012_CORE;                                                        
INFILE 'CO_SASD_2012_CORE.ASC' LRECL = 1250;                                    
...
INPUT                                                                           
      ...
      @998    PSTCO                    N5PF.                                    
      @1003   PSTCO2                   N5PF.                                    
      @1008   PointOfOriginUB04        $CHAR1.                                  
      @1009   PointOfOrigin_X          $CHAR1.                                  
      @1010   RACE                     N2PF.                                    
      @1012   RACE_X                   $CHAR1.                                  
      @1013   STATE_AS                 N2PF.                                    
      @1015   STATE_ED                 N2PF.                                    
      @1017   STATE_OS                 N2PF.                                    
      @1019   TOTCHG                   N10PF.                                   
      @1029   TOTCHG_X                 N15P2F.                                  
      @1044   YEAR                     N4PF.                                    
      @1048   ZIP3                     $CHAR3.                                  
      @1051   ZIPINC_QRTL              N3PF.                                    
      @1054   ZIP                      $CHAR5.                                  
      @1059   AYEAR                    N4PF.                                    
      @1063   DMONTH                   N2PF.                                    
      @1065   BMONTH                   N2PF.                                    
