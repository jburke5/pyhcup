...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SASDC_2008_CORE;                                                        
INFILE 'WI_SASD_2008_CORE.ASC' LRECL = 1191;                                    
...
INPUT                                                                           
      ...
      @665    DXCCS29                  N4PF.                                    
      @669    DXCCS30                  N4PF.                                    
      @673    DX_Visit_Reason1         $CHAR5.                                  
      @678    DX_Visit_Reason2         $CHAR5.                                  
      @683    DX_Visit_Reason3         $CHAR5.                                  
      @688    ECODE1                   $CHAR5.                                  
      @693    ECODE2                   $CHAR5.                                  
      @698    ECODE3                   $CHAR5.                                  
      @703    ECODE4                   $CHAR5.                                  
      ...
      @879    PL_CBSA                  N3PF.                                    
      @882    PL_MSA1993               N3PF.                                    
      @885    PL_NCHS2006              N2PF.                                    
      @887    PL_RUCA10_2005           N2PF.                                    
      @889    PL_RUCA2005              N4P1F.                                   
      @893    PL_RUCA4_2005            N2PF.                                    
      @895    PL_RUCC2003              N2PF.                                    
      @897    PL_UIC2003               N2PF.                                    
      @899    PL_UR_CAT4               N2PF.                                    
      @901    PR1                      $CHAR4.                                  
      @905    PR2                      $CHAR4.                                  
      ...
      @1119   PSTATE                   $CHAR2.                                  
      @1121   PSTCO2                   N5PF.                                    
      @1126   PointOfOriginUB04        $CHAR1.                                  
      @1127   PointOfOrigin_X          $CHAR1.                                  
      @1128   RACE                     N2PF.                                    
      @1130   RACE_X                   $CHAR1.                                  
      @1131   STATE_AS                 N2PF.                                    
      @1133   STATE_ED                 N2PF.                                    
