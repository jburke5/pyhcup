...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SEDDC_2008_CORE;                                                        
INFILE 'HI_SEDD_2008_CORE.ASC' LRECL = 751;                                     
...
INPUT                                                                           
      ...
      @616    PSTATE                   $CHAR2.                                  
      @618    PSTCO2                   N5PF.                                    
      @623    PointOfOriginUB04        $CHAR1.                                  
      @624    PointOfOrigin_X          $CHAR1.                                  
      @625    RACE                     N2PF.                                    
      @627    RACE_X                   $CHAR2.                                  
      @629    STATE_AS                 N2PF.                                    
      @631    STATE_ED                 N2PF.                                    
