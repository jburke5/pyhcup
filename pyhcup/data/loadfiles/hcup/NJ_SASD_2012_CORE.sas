...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SASDC_2012_CORE;                                                        
INFILE 'NJ_SASD_2012_CORE.ASC' LRECL = 1569;                                    
...
INPUT                                                                           
      ...
      @1376   PSTCO                    N5PF.                                    
      @1381   PSTCO2                   N5PF.                                    
      @1386   PointOfOriginUB04        $CHAR1.                                  
      @1387   PointOfOrigin_X          $CHAR1.                                  
      @1388   PrimLang                 $CHAR3.                                  
      @1391   RACE                     N2PF.                                    
      @1393   RACE_X                   $CHAR5.                                  
      @1398   READMIT                  N2PF.                                    
      ...
      @1404   STATE_OS                 N2PF.                                    
      @1406   TOTCHG                   N10PF.                                   
      @1416   TOTCHG_X                 N15P2F.                                  
      @1431   YEAR                     N4PF.                                    
      @1435   ZIP3                     $CHAR3.                                  
      @1438   ZIPINC_QRTL              N3PF.                                    
      @1441   TOWN                     $CHAR4.                                  
      @1445   ZIP                      $CHAR5.                                  
      @1450   AYEAR                    N4PF.                                    
      @1454   DMONTH                   N2PF.                                    
