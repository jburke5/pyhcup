...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2010_CORE;                                                        
INFILE 'WI_SEDD_2010_CORE.ASC' LRECL = 1176;                                    
...
INPUT                                                                           
      ...
      @669    DXCCS29                  N4PF.                                    
      @673    DXCCS30                  N4PF.                                    
      @677    DX_Visit_Reason1         $CHAR5.                                  
      @682    DX_Visit_Reason2         $CHAR5.                                  
      @687    DX_Visit_Reason3         $CHAR5.                                  
      @692    ECODE1                   $CHAR5.                                  
      @697    ECODE2                   $CHAR5.                                  
      @702    ECODE3                   $CHAR5.                                  
      @707    ECODE4                   $CHAR5.                                  
      ...
      @861    PL_CBSA                  N3PF.                                    
      @864    PL_MSA1993               N3PF.                                    
      @867    PL_NCHS2006              N2PF.                                    
      @869    PL_RUCA10_2005           N2PF.                                    
      @871    PL_RUCA2005              N4P1F.                                   
      @875    PL_RUCA4_2005            N2PF.                                    
      @877    PL_RUCC2003              N2PF.                                    
      @879    PL_UIC2003               N2PF.                                    
      @881    PL_UR_CAT4               N2PF.                                    
      @883    PR1                      $CHAR4.                                  
      @887    PR2                      $CHAR4.                                  
      ...
      @1101   PSTATE                   $CHAR2.                                  
      @1103   PSTCO2                   N5PF.                                    
      @1108   PointOfOriginUB04        $CHAR1.                                  
      @1109   PointOfOrigin_X          $CHAR1.                                  
      @1110   RACE                     N2PF.                                    
      @1112   RACE_X                   $CHAR1.                                  
      @1113   STATE_AS                 N2PF.                                    
      @1115   STATE_ED                 N2PF.                                    
