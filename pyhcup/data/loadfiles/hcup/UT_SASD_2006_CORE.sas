...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SASDC_2006_CORE;                                                        
INFILE 'UT_SASD_2006_CORE.ASC' LRECL = 480;                                     
...
ATTRIB                                                                          
  ...
  APGTYPE2                   LENGTH=3                                           
  LABEL="Ambulatory Patient Group Type 2 (as received from source)"             
                                                                                
  APGTYPE3                   LENGTH=3                                           
  LABEL="Ambulatory Patient Group Type 3 (as received from source)"             
                                                                                
  APGTYPE4                   LENGTH=3                                           
  LABEL="Ambulatory Patient Group Type 4 (as received from source)"             
                                                                                
  APGTYPE5                   LENGTH=3                                           
  LABEL="Ambulatory Patient Group Type 5 (as received from source)"             
                                                                                
  APGTYPE6                   LENGTH=3                                           
  LABEL="Ambulatory Patient Group Type 6 (as received from source)"             
