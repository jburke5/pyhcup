...
INFILE 'SC_SID_2011_CORE.ASC' LRECL = 583;                                      
...
INPUT                                                                           
      ...
      @293    HCUP_ED                  N2PF.                                    
      @295    HCUP_OS                  N2PF.                                    
      @297    HCUP_SURGERY_BROAD       N2PF.                                    
      @299    HCUP_SURGERY_NARROW      N2PF.                                    
      @301    HOSPBRTH                 N3PF.                                    
      @304    HOSPST                   $CHAR2.                                  
      @306    KEY                      18.                                      
      @324    LOS                      N5PF.                                    
      ...
      @362    PAY1                     N2PF.                                    
      @364    PAY1_X                   $CHAR2.                                  
      @366    PL_NCHS2006              N2PF.                                    
      @368    PL_RUCA10_2005           N2PF.                                    
      @370    PL_RUCA4_2005            N2PF.                                    
      @372    PL_UR_CAT4               N2PF.                                    
      @374    PR1                      $CHAR4.                                  
      @378    PR2                      $CHAR4.                                  
      @382    PR3                      $CHAR4.                                  
      ...
      @533    PSTATE                   $CHAR2.                                  
      @535    PSTCO                    N5PF.                                    
      @540    PointOfOriginUB04        $CHAR1.                                  
      @541    PointOfOrigin_X          $CHAR1.                                  
      @542    RACE                     N2PF.                                    
      @544    RACE_X                   $CHAR1.                                  
      @545    TOTCHG                   N10PF.                                   
      @555    TOTCHG_X                 N15P2F.                                  
