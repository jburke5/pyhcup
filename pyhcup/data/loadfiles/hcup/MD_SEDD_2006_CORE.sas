...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2006_CORE;                                                        
INFILE 'MD_SEDD_2006_CORE.ASC' LRECL = 1282;                                    
...
INPUT                                                                           
      ...
      @1198   PAYER2_X                 $CHAR2.                                  
      @1200   PL_CBSA                  N3PF.                                    
      @1203   PL_MSA1993               N3PF.                                    
      @1206   PL_NHCS2006              N2PF.                                    
      @1208   PL_RUCA10_2005           N2PF.                                    
      @1210   PL_RUCA2005              N4P1F.                                   
      @1214   PL_RUCA4_2005            N2PF.                                    
      @1216   PL_RUCC2003              N2PF.                                    
      @1218   PL_UIC2003               N2PF.                                    
      @1220   PL_UR_CAT4               N2PF.                                    
      @1222   PL_UR_CAT5               N2PF.                                    
      @1224   PROCTYPE                 N3PF.                                    
      @1227   PSTATE                   $CHAR2.                                  
      @1229   PSTCO                    N5PF.                                    
      @1234   PSTCO2                   N5PF.                                    
      ...
      @1246   STATE_OS                 N2PF.                                    
      @1248   TOTCHG                   N10PF.                                   
      @1258   TOTCHG_X                 N15P2F.                                  
      @1273   YEAR                     N4PF.                                    
      @1277   ZIP3                     $CHAR3.                                  
      @1280   ZIPINC_QRTL              N3PF.                                    
      ;                                                                         
