...
INFILE 'MD_SID_2009_CORE.ASC' LRECL = 837;                                      
...
INPUT                                                                           
      ...
      @490    HCUP_ED                  N2PF.                                    
      @492    HCUP_OS                  N2PF.                                    
      @494    HISPANIC_X               $CHAR1.                                  
      @495    HOSPBRTH                 N3PF.                                    
      @498    HOSPST                   $CHAR2.                                  
      @500    HospitalUnit             N2PF.                                    
      @502    KEY                      14.                                      
      @516    LOS                      N5PF.                                    
      @521    LOS_X                    N6PF.                                    
      @527    MARITALSTATUSUB04        $CHAR1.                                  
      @528    MARITALSTATUS_X          $CHAR1.                                  
      @529    MDC                      N2PF.                                    
      @531    MDC24                    N2PF.                                    
      @533    MDNUM1_R                 N9PF.                                    
      @542    MDNUM2_R                 N9PF.                                    
      ...
      @587    PL_CBSA                  N3PF.                                    
      @590    PL_MSA1993               N3PF.                                    
      @593    PL_NCHS2006              N2PF.                                    
      @595    PL_RUCA10_2005           N2PF.                                    
      @597    PL_RUCA2005              N4P1F.                                   
      @601    PL_RUCA4_2005            N2PF.                                    
      @603    PL_RUCC2003              N2PF.                                    
      @605    PL_UIC2003               N2PF.                                    
      @607    PL_UR_CAT4               N2PF.                                    
      @609    PR1                      $CHAR4.                                  
      @613    PR2                      $CHAR4.                                  
