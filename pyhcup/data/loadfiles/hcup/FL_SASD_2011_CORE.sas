...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SASDC_2011_CORE;                                                        
INFILE 'FL_SASD_2011_CORE.ASC' LRECL = 685;                                     
...
INPUT                                                                           
      ...
      @409    DXCCS9                   N4PF.                                    
      @413    DXCCS10                  N4PF.                                    
      @417    DX_Visit_Reason1         $CHAR5.                                  
      @422    DaysToEvent              N6PF.                                    
      @428    ECODE1                   $CHAR5.                                  
      @433    ECODE2                   $CHAR5.                                  
      @438    ECODE3                   $CHAR5.                                  
      @443    E_CCS1                   N4PF.                                    
      ...
      @457    HCUP_ED                  N2PF.                                    
      @459    HCUP_OS                  N2PF.                                    
      @461    HCUP_SURGERY_BROAD       N2PF.                                    
      @463    HCUP_SURGERY_NARROW      N2PF.                                    
      @465    HISPANIC_X               $CHAR8.                                  
      @473    HOSPBRTH                 N3PF.                                    
      @476    HOSPST                   $CHAR2.                                  
      @478    Homeless                 N2PF.                                    
      @480    KEY                      18.                                      
      ...
      @548    NEOMAT                   N2PF.                                    
      @550    NPR                      N2PF.                                    
      @552    OFFSITE_ED_X             $CHAR1.                                  
      @553    ORPROC                   N2PF.                                    
      @555    PAY1                     N2PF.                                    
      @557    PAY1_X                   $CHAR1.                                  
      @558    PL_CBSA                  N3PF.                                    
      @561    PL_MSA1993               N3PF.                                    
      @564    PL_NCHS2006              N2PF.                                    
      @566    PL_RUCA10_2005           N2PF.                                    
      @568    PL_RUCA2005              N4P1F.                                   
      @572    PL_RUCA4_2005            N2PF.                                    
      @574    PL_RUCC2003              N2PF.                                    
      @576    PL_UIC2003               N2PF.                                    
      @578    PL_UR_CAT4               N2PF.                                    
      @580    PR1                      $CHAR4.                                  
      @584    PR2                      $CHAR4.                                  
