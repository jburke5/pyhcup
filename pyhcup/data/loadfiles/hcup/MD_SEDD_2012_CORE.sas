...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2012_CORE;                                                        
INFILE 'MD_SEDD_2012_CORE.ASC' LRECL = 1203;                                    
...
INPUT                                                                           
      ...
      @1114   PAYER2_X                 $CHAR2.                                  
      @1116   PL_CBSA                  N3PF.                                    
      @1119   PL_MSA1993               N3PF.                                    
      @1122   PL_NCHS2006              N2PF.                                    
      @1124   PL_RUCA10_2005           N2PF.                                    
      @1126   PL_RUCA2005              N4P1F.                                   
      @1130   PL_RUCA4_2005            N2PF.                                    
      @1132   PL_RUCC2003              N2PF.                                    
      @1134   PL_UIC2003               N2PF.                                    
      @1136   PL_UR_CAT4               N2PF.                                    
      @1138   PROCTYPE                 N3PF.                                    
      @1141   PSTATE                   $CHAR2.                                  
      @1143   PSTCO                    N5PF.                                    
      @1148   PSTCO2                   N5PF.                                    
      ...
      @1158   STATE_ED                 N2PF.                                    
      @1160   STATE_OS                 N2PF.                                    
      @1162   SpannedServiceCount      N3PF.                                    
      @1165   TOTCHG                   N10PF.                                   
      @1175   TOTCHG_X                 N15P2F.                                  
      @1190   YEAR                     N4PF.                                    
      @1194   ZIP3                     $CHAR3.                                  
      @1197   ZIPINC_QRTL              N3PF.                                    
      @1200   AYEAR                    N4PF.                                    
      ;                                                                         
