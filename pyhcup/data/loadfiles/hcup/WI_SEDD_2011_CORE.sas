...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2011_CORE;                                                        
INFILE 'WI_SEDD_2011_CORE.ASC' LRECL = 1200;                                    
...
INPUT                                                                           
      ...
      @775    HCUP_ED                  N2PF.                                    
      @777    HCUP_OS                  N2PF.                                    
      @779    HCUP_SURGERY_BROAD       N2PF.                                    
      @781    HCUP_SURGERY_NARROW      N2PF.                                    
      @783    HISPANIC_X               $CHAR1.                                  
      @784    HOSPBRTH                 N3PF.                                    
      @787    HOSPST                   $CHAR2.                                  
      @789    HOSP_NPI                 $CHAR10.                                 
      @799    Homeless                 N2PF.                                    
      ...
      @1125   PSTATE                   $CHAR2.                                  
      @1127   PSTCO2                   N5PF.                                    
      @1132   PointOfOriginUB04        $CHAR1.                                  
      @1133   PointOfOrigin_X          $CHAR1.                                  
      @1134   RACE                     N2PF.                                    
      @1136   RACE_X                   $CHAR1.                                  
      @1137   STATE_AS                 N2PF.                                    
      @1139   STATE_ED                 N2PF.                                    
      @1141   STATE_OS                 N2PF.                                    
      @1143   TOTCHG                   N10PF.                                   
      @1153   TOTCHG_X                 N15P2F.                                  
      @1168   YEAR                     N4PF.                                    
      @1172   ZIP3                     $CHAR3.                                  
      @1175   ZIPINC_QRTL              N3PF.                                    
      @1178   ZIP                      $CHAR5.                                  
      @1183   AYEAR                    N4PF.                                    
      @1187   DMONTH                   N2PF.                                    
      @1189   BMONTH                   N2PF.                                    
