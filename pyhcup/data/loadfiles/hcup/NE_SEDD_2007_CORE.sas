...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2007_CORE;                                                        
INFILE 'NE_SEDD_2007_CORE.ASC' LRECL = 471;                                     
...
INPUT                                                                           
      ...
      @245    PL_CBSA                  N3PF.                                    
      @248    PL_MSA1993               N3PF.                                    
      @251    PL_NCHS2006              N2PF.                                    
      @253    PL_RUCA10_2005           N2PF.                                    
      @255    PL_RUCA2005              N4P1F.                                   
      @259    PL_RUCA4_2005            N2PF.                                    
      @261    PL_RUCC2003              N2PF.                                    
      @263    PL_UIC2003               N2PF.                                    
      @265    PL_UR_CAT4               N2PF.                                    
      @267    PR1                      $CHAR4.                                  
      @271    PR2                      $CHAR4.                                  
      ...
      @342    PSTATE                   $CHAR2.                                  
      @344    PSTCO2                   N5PF.                                    
      @349    PointOfOriginUB04        $CHAR1.                                  
      @350    PointOfOrigin_X          $CHAR1.                                  
      @351    STATE_AS                 N2PF.                                    
      @353    STATE_ED                 N2PF.                                    
      @355    STATE_OS                 N2PF.                                    
      @357    TOTCHG                   N10PF.                                   
