...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2011_CORE;                                                        
INFILE 'NY_SEDD_2011_CORE.ASC' LRECL = 810;                                     
...
INPUT                                                                           
      ...
      @612    HCUP_ED                  N2PF.                                    
      @614    HCUP_OS                  N2PF.                                    
      @616    HCUP_SURGERY_BROAD       N2PF.                                    
      @618    HCUP_SURGERY_NARROW      N2PF.                                    
      @620    HISPANIC_X               $CHAR1.                                  
      @621    HOSPBRTH                 N3PF.                                    
      @624    HOSPST                   $CHAR2.                                  
      @626    Homeless                 N2PF.                                    
      @628    KEY                      18.                                      
