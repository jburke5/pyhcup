...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2009_CORE;                                                        
INFILE 'MA_SEDD_2009_CORE.ASC' LRECL = 638;                                     
...
INPUT                                                                           
      ...
      @596    TOTCHG                   N10PF.                                   
      @606    TOTCHG_X                 N15P2F.                                  
      @621    TransportToHosp          N2PF.                                    
      @623    YEAR                     N4PF.                                    
      @627    ZIP3                     $CHAR3.                                  
      @630    ZIPINC_QRTL              N3PF.                                    
      @633    AYEAR                    N4PF.                                    
      @637    DMONTH                   N2PF.                                    
      ;                                                                         
