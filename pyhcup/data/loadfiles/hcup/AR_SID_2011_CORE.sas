...
INFILE 'AR_SID_2011_CORE.ASC' LRECL = 713;                                      
...
INPUT                                                                           
      ...
      @342    HCUP_ED                  N2PF.                                    
      @344    HCUP_OS                  N2PF.                                    
      @346    HCUP_SURGERY_BROAD       N2PF.                                    
      @348    HCUP_SURGERY_NARROW      N2PF.                                    
      @350    HISPANIC_X               $CHAR1.                                  
      @351    HOSPBRTH                 N3PF.                                    
      @354    HOSPST                   $CHAR2.                                  
      @356    KEY                      18.                                      
      @374    LOS                      N5PF.                                    
      @379    LOS_X                    N6PF.                                    
      @385    MARITALSTATUSUB04        $CHAR1.                                  
      @386    MARITALSTATUS_X          $CHAR1.                                  
      @387    MDC                      N2PF.                                    
      @389    MDC24                    N2PF.                                    
      @391    MDC_NoPOA                N2PF.                                    
      @393    MDNUM1_R                 N9PF.                                    
