...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2011_CORE;                                                        
INFILE 'KY_SEDD_2011_CORE.ASC' LRECL = 914;                                     
...
INPUT                                                                           
      ...
      @727    HCUP_ED                  N2PF.                                    
      @729    HCUP_OS                  N2PF.                                    
      @731    HCUP_SURGERY_BROAD       N2PF.                                    
      @733    HCUP_SURGERY_NARROW      N2PF.                                    
      @735    HISPANIC_X               $CHAR2.                                  
      @737    HOSPBRTH                 N3PF.                                    
      @740    HOSPST                   $CHAR2.                                  
      @742    KEY                      18.                                      
      @760    LOS                      N5PF.                                    
      ...
      @816    PL_CBSA                  N3PF.                                    
      @819    PL_MSA1993               N3PF.                                    
      @822    PL_NCHS2006              N2PF.                                    
      @824    PL_RUCA10_2005           N2PF.                                    
      @826    PL_RUCA2005              N4P1F.                                   
      @830    PL_RUCA4_2005            N2PF.                                    
      @832    PL_RUCC2003              N2PF.                                    
      @834    PL_UIC2003               N2PF.                                    
      @836    PL_UR_CAT4               N2PF.                                    
      @838    PROCTYPE                 N3PF.                                    
      @841    PSTATE                   $CHAR2.                                  
