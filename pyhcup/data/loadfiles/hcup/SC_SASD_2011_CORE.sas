...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SASDC_2011_CORE;                                                        
INFILE 'SC_SASD_2011_CORE.ASC' LRECL = 368;                                     
...
INPUT                                                                           
      ...
      @181    HCUP_ED                  N2PF.                                    
      @183    HCUP_OS                  N2PF.                                    
      @185    HCUP_SURGERY_BROAD       N2PF.                                    
      @187    HCUP_SURGERY_NARROW      N2PF.                                    
      @189    HOSPBRTH                 N3PF.                                    
      @192    HOSPST                   $CHAR2.                                  
      @194    KEY                      18.                                      
      @212    MDSPEC1                  $CHAR3.                                  
      ...
      @233    PAY1                     N2PF.                                    
      @235    PAY1_X                   $CHAR2.                                  
      @237    PL_NCHS2006              N2PF.                                    
      @239    PL_RUCA10_2005           N2PF.                                    
      @241    PL_RUCA4_2005            N2PF.                                    
      @243    PR1                      $CHAR4.                                  
      @247    PR2                      $CHAR4.                                  
      @251    PR3                      $CHAR4.                                  
      @255    PR4                      $CHAR4.                                  
      ...
      @316    PSTATE                   $CHAR2.                                  
      @318    PSTCO                    N5PF.                                    
      @323    PointOfOriginUB04        $CHAR1.                                  
      @324    PointOfOrigin_X          $CHAR1.                                  
      @325    RACE                     N2PF.                                    
      @327    RACE_X                   $CHAR1.                                  
      @328    STATE_AS                 N2PF.                                    
      @330    STATE_ED                 N2PF.                                    
