...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2012_CORE;                                                        
INFILE 'KY_SEDD_2012_CORE.ASC' LRECL = 1292;                                    
...
INPUT                                                                           
      ...
      @1014   DXCCS24                  N4PF.                                    
      @1018   DXCCS25                  N4PF.                                    
      @1022   DX_Visit_Reason1         $CHAR5.                                  
      @1027   DX_Visit_Reason2         $CHAR5.                                  
      @1032   DX_Visit_Reason3         $CHAR5.                                  
      @1037   ECODE1                   $CHAR5.                                  
      @1042   ECODE2                   $CHAR5.                                  
      @1047   ECODE3                   $CHAR5.                                  
      @1052   ECODE4                   $CHAR5.                                  
      ...
      @1102   HCUP_ED                  N2PF.                                    
      @1104   HCUP_OS                  N2PF.                                    
      @1106   HISPANIC_X               $CHAR2.                                  
      @1108   HOSPBRTH                 N3PF.                                    
      @1111   HOSPST                   $CHAR2.                                  
      @1113   HOSP_NPI                 $CHAR10.                                 
      @1123   KEY                      15.                                      
      @1138   LOS                      N5PF.                                    
      @1143   LOS_X                    N6PF.                                    
      @1149   MEDINCSTQ                N2PF.                                    
      ...
      @1189   PAY3_X                   $CHAR5.                                  
      @1194   PL_CBSA                  N3PF.                                    
      @1197   PL_MSA1993               N3PF.                                    
      @1200   PL_NCHS2006              N2PF.                                    
      @1202   PL_RUCA10_2005           N2PF.                                    
      @1204   PL_RUCA2005              N4P1F.                                   
      @1208   PL_RUCA4_2005            N2PF.                                    
      @1210   PL_RUCC2003              N2PF.                                    
      @1212   PL_UIC2003               N2PF.                                    
      @1214   PL_UR_CAT4               N2PF.                                    
      @1216   PROCTYPE                 N3PF.                                    
      @1219   PSTATE                   $CHAR2.                                  
      @1221   PSTCO                    N5PF.                                    
      @1226   PSTCO2                   N5PF.                                    
      @1231   PointOfOriginUB04        $CHAR1.                                  
      @1232   PointOfOrigin_X          $CHAR2.                                  
      @1234   RACE                     N2PF.                                    
      @1236   RACE_X                   $CHAR2.                                  
      @1238   STATE_AS                 N2PF.                                    
      @1240   STATE_ED                 N2PF.                                    
      @1242   STATE_OS                 N2PF.                                    
      @1244   TOTCHG                   N10PF.                                   
      @1254   TOTCHG_X                 N15P2F.                                  
      @1269   YEAR                     N4PF.                                    
      @1273   ZIPINC_QRTL              N3PF.                                    
      @1276   ZIP                      $CHAR5.                                  
      @1281   AYEAR                    N4PF.                                    
      @1285   DMONTH                   N2PF.                                    
      @1287   BMONTH                   N2PF.                                    
