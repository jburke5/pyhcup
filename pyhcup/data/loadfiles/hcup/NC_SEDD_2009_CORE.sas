...
*  Data Step                  *;                                                
*******************************;                                                
DATA NC_SEDDC_2009_CORE;                                                        
INFILE 'NC_SEDD_2009_CORE.ASC' LRECL = 796;                                     
...
INPUT                                                                           
      ...
      @255    DXCCS23                  N4PF.                                    
      @259    DXCCS24                  N4PF.                                    
      @263    DX_Visit_Reason1         $CHAR5.                                  
      @268    DaysToEvent              N6PF.                                    
      @274    ECODE1                   $CHAR5.                                  
      @279    ECODE2                   $CHAR5.                                  
      @284    ECODE3                   $CHAR5.                                  
      @289    ECODE4                   $CHAR5.                                  
