...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SASDC_2010_CORE;                                                        
INFILE 'MI_SASD_2010_CORE.ASC' LRECL = 1086;                                    
...
INPUT                                                                           
      ...
      @766    PL_CBSA                  N3PF.                                    
      @769    PL_MSA1993               N3PF.                                    
      @772    PL_NCHS2006              N2PF.                                    
      @774    PL_RUCA10_2005           N2PF.                                    
      @776    PL_RUCA2005              N4P1F.                                   
      @780    PL_RUCA4_2005            N2PF.                                    
      @782    PL_RUCC2003              N2PF.                                    
      @784    PL_UIC2003               N2PF.                                    
      @786    PL_UR_CAT4               N2PF.                                    
      @788    PR1                      $CHAR4.                                  
      @792    PR2                      $CHAR4.                                  
      ...
      @1006   PSTATE                   $CHAR2.                                  
      @1008   PSTCO2                   N5PF.                                    
      @1013   PointOfOriginUB04        $CHAR1.                                  
      @1014   PointOfOrigin_X          $CHAR1.                                  
      @1015   RACE                     N2PF.                                    
      @1017   RACE_X                   $CHAR1.                                  
      @1018   STATE_AS                 N2PF.                                    
      @1020   STATE_ED                 N2PF.                                    
      @1022   STATE_OS                 N2PF.                                    
      @1024   TOTCHG                   N10PF.                                   
      @1034   TOTCHG_X                 N15P2F.                                  
      @1049   YEAR                     N4PF.                                    
      @1053   ZIP3                     $CHAR3.                                  
      @1056   ZIPINC_QRTL              N3PF.                                    
      @1059   HOSPID                   N5PF.                                    
      @1064   ZIP                      $CHAR5.                                  
      @1069   AYEAR                    N4PF.                                    
      @1073   DMONTH                   N2PF.                                    
