...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2006_CORE;                                                        
INFILE 'MA_SEDD_2006_CORE.ASC' LRECL = 763;                                     
...
INPUT                                                                           
      ...
      @459    CPT86                    $CHAR5.                                  
      @464    CPT87                    $CHAR5.                                  
      @469    DaysBetweenVisits        N4PF.                                    
      @473    DHOUR                    N4PF.                                    
      @477    DIED                     N2PF.                                    
      @479    DISP_X                   $CHAR1.                                  
      @480    DISPUNIFORM              N2PF.                                    
      @482    DQTR                     N2PF.                                    
      @484    DSHOSPID                 $CHAR13.                                 
      @497    DX1                      $CHAR5.                                  
      @502    DX2                      $CHAR5.                                  
