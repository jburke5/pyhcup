...
INFILE 'SD_SID_2009_CORE.ASC' LRECL = 2259;                                     
...
INPUT                                                                           
      ...
      @984    PL_CBSA                  N3PF.                                    
      @987    PL_MSA1993               N3PF.                                    
      @990    PL_NCHS2006              N2PF.                                    
      @992    PL_RUCA10_2005           N2PF.                                    
      @994    PL_RUCA2005              N4P1F.                                   
      @998    PL_RUCA4_2005            N2PF.                                    
      @1000   PL_RUCC2003              N2PF.                                    
      @1002   PL_UIC2003               N2PF.                                    
      ...
      @1791   PSTCO                    N5PF.                                    
      @1796   PSTCO2                   N5PF.                                    
      @1801   PointOfOriginUB04        $CHAR1.                                  
      @1802   PointOfOrigin_X          $CHAR1.                                  
      @1803   RACE                     N2PF.                                    
      @1805   RACE_X                   $CHAR4.                                  
      @1809   TOTCHG                   N10PF.                                   
      @1819   TOTCHG_X                 N15P2F.                                  
      @1834   TRAN_IN                  N2PF.                                    
      @1836   TRAN_OUT                 N2PF.                                    
      @1838   YEAR                     N4PF.                                    
      @1842   ZIP3                     $CHAR3.                                  
      @1845   ZIPINC_QRTL              N3PF.                                    
      @1848   HOSPID                   N5PF.                                    
      @1853   ZIP                      $CHAR5.                                  
      @1858   AYEAR                    N4PF.                                    
      @1862   DMONTH                   N2PF.                                    
