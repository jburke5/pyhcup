...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SASDC_2011_CORE;                                                        
INFILE 'MI_SASD_2011_CORE.ASC' LRECL = 1088;                                    
...
INPUT                                                                           
      ...
      @672    HCUP_ED                  N2PF.                                    
      @674    HCUP_OS                  N2PF.                                    
      @676    HCUP_SURGERY_BROAD       N2PF.                                    
      @678    HCUP_SURGERY_NARROW      N2PF.                                    
      @680    HISPANIC_X               $CHAR1.                                  
      @681    HOSPBRTH                 N3PF.                                    
      @684    HOSPST                   $CHAR2.                                  
      @686    KEY                      18.                                      
      @704    LOS                      N5PF.                                    
      ...
      @768    PL_CBSA                  N3PF.                                    
      @771    PL_MSA1993               N3PF.                                    
      @774    PL_NCHS2006              N2PF.                                    
      @776    PL_RUCA10_2005           N2PF.                                    
      @778    PL_RUCA2005              N4P1F.                                   
      @782    PL_RUCA4_2005            N2PF.                                    
      @784    PL_RUCC2003              N2PF.                                    
      @786    PL_UIC2003               N2PF.                                    
      @788    PL_UR_CAT4               N2PF.                                    
      @790    PR1                      $CHAR4.                                  
      @794    PR2                      $CHAR4.                                  
      ...
      @1008   PSTATE                   $CHAR2.                                  
      @1010   PSTCO2                   N5PF.                                    
      @1015   PointOfOriginUB04        $CHAR1.                                  
      @1016   PointOfOrigin_X          $CHAR1.                                  
      @1017   RACE                     N2PF.                                    
      @1019   RACE_X                   $CHAR1.                                  
      @1020   STATE_AS                 N2PF.                                    
      @1022   STATE_ED                 N2PF.                                    
