...
INFILE 'RI_SID_2009_CORE.ASC' LRECL = 1136;                                     
...
INPUT                                                                           
      ...
      @570    NEOMAT                   N2PF.                                    
      @572    NPR                      N2PF.                                    
      @574    OBSERVATION              N4PF.                                    
      @578    ORPROC                   N2PF.                                    
      @580    PAY1                     N2PF.                                    
      @582    PAY1_X                   $CHAR7.                                  
      @589    PL_CBSA                  N3PF.                                    
      @592    PL_MSA1993               N3PF.                                    
      @595    PL_NCHS2006              N2PF.                                    
      @597    PL_RUCA10_2005           N2PF.                                    
      @599    PL_RUCA2005              N4P1F.                                   
      @603    PL_RUCA4_2005            N2PF.                                    
      @605    PL_RUCC2003              N2PF.                                    
      @607    PL_UIC2003               N2PF.                                    
      @609    PL_UR_CAT4               N2PF.                                    
      @611    PR1                      $CHAR4.                                  
      @615    PR2                      $CHAR4.                                  
      ...
      @916    PSTCO                    N5PF.                                    
      @921    PSTCO2                   N5PF.                                    
      @926    PointOfOriginUB04        $CHAR1.                                  
      @927    PointOfOrigin_X          $CHAR1.                                  
      @928    RACE                     N2PF.                                    
      @930    RACE_X                   $CHAR8.                                  
      @938    TOTCHG                   N10PF.                                   
      @948    TOTCHG_X                 N15P2F.                                  
