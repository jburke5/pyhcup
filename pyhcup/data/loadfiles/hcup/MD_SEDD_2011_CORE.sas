...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2011_CORE;                                                        
INFILE 'MD_SEDD_2011_CORE.ASC' LRECL = 901;                                     
...
INPUT                                                                           
      ...
      @715    HCUP_ED                  N2PF.                                    
      @717    HCUP_OS                  N2PF.                                    
      @719    HCUP_SURGERY_BROAD       N2PF.                                    
      @721    HCUP_SURGERY_NARROW      N2PF.                                    
      @723    HISPANIC_X               $CHAR1.                                  
      @724    HOSPBRTH                 N3PF.                                    
      @727    HOSPST                   $CHAR2.                                  
      @729    KEY                      18.                                      
      @747    LOS                      N5PF.                                    
      @752    LOS_X                    N6PF.                                    
      @758    MARITALSTATUSUB04        $CHAR1.                                  
      @759    MARITALSTATUS_X          $CHAR1.                                  
      @760    MDNUM1_R                 N9PF.                                    
      @769    MEDINCSTQ                N2PF.                                    
      @771    MRN_R                    N9PF.                                    
      @780    NCHRONIC                 N3PF.                                    
      ...
      @814    PL_CBSA                  N3PF.                                    
      @817    PL_MSA1993               N3PF.                                    
      @820    PL_NCHS2006              N2PF.                                    
      @822    PL_RUCA10_2005           N2PF.                                    
      @824    PL_RUCA2005              N4P1F.                                   
      @828    PL_RUCA4_2005            N2PF.                                    
      @830    PL_RUCC2003              N2PF.                                    
      @832    PL_UIC2003               N2PF.                                    
      @834    PL_UR_CAT4               N2PF.                                    
      @836    PROCTYPE                 N3PF.                                    
      @839    PSTATE                   $CHAR2.                                  
