...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SASDC_2005_CORE;                                                        
INFILE 'NJ_SASD_2005_CORE.ASC' LRECL = 434;                                     
...
INPUT                                                                           
      ...
      @184    HCUP_ED                  N2PF.                                    
      @186    HCUP_OS                  N2PF.                                    
      @188    HISPANIC_X               $CHAR1.                                  
      @189    HOSPST                   $CHAR2.                                  
      @191    LOS                      N5PF.                                    
      @196    LOS_X                    N6PF.                                    
      @202    MARITALSTATUS            $CHAR1.                                  
      @203    MDNUM1_R                 N9PF.                                    
      @212    MDNUM2_R                 N9PF.                                    
      @221    MDSPEC1                  $CHAR1.                                  
      @222    MEDINCSTQ                N2PF.                                    
      ...
      @254    PL_CBSA                  N3PF.                                    
      @257    PL_MSA1993               N3PF.                                    
      @260    PL_NHCS2006              N2PF.                                    
      @262    PL_RUCA10_2005           N2PF.                                    
      @264    PL_RUCA2005              N4P1F.                                   
      @268    PL_RUCA4_2005            N2PF.                                    
      @270    PL_RUCC2003              N2PF.                                    
      @272    PL_UIC2003               N2PF.                                    
      @274    PL_UR_CAT4               N2PF.                                    
      @276    PL_UR_CAT5               N2PF.                                    
      @278    PR1                      $CHAR4.                                  
