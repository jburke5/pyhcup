...
INFILE 'UT_SID_2009_CORE.ASC' LRECL = 443;                                      
...
INPUT                                                                           
      ...
      @295    PL_CBSA                  N3PF.                                    
      @298    PL_MSA1993               N3PF.                                    
      @301    PL_NCHS2006              N2PF.                                    
      @303    PL_RUCA10_2005           N2PF.                                    
      @305    PL_RUCA2005              N4P1F.                                   
      @309    PL_RUCA4_2005            N2PF.                                    
      @311    PL_RUCC2003              N2PF.                                    
      @313    PL_UIC2003               N2PF.                                    
      @315    PL_UR_CAT4               N2PF.                                    
      @317    PR1                      $CHAR4.                                  
      @321    PR2                      $CHAR4.                                  
      ...
      @364    PSTCO                    N5PF.                                    
      @369    PSTCO2                   N5PF.                                    
      @374    PointOfOriginUB04        $CHAR1.                                  
      @375    PointOfOrigin_X          $CHAR1.                                  
      @376    RACE                     N2PF.                                    
      @378    RACE_X                   $CHAR1.                                  
      @379    TOTCHG                   N10PF.                                   
      @389    TOTCHG_X                 N15P2F.                                  
