...
INFILE 'HI_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1006;                          
...
INPUT                                                                           
      ...
      @460    PL_CBSA                       N3PF.                               
      @463    PL_NCHS                       N2PF.                               
      @465    PL_RUCA10_2005                N2PF.                               
      @467    PL_RUCA2005                   N4P1F.                              
      @471    PL_RUCA4_2005                 N2PF.                               
      @473    PL_RUCC                       N2PF.                               
      @475    PL_UIC                        N2PF.                               
      @477    PL_UR_CAT4                    N2PF.                               
      @479    PR1                           $CHAR4.                             
      ...
      @782    PSTATE                        $CHAR2.                             
      @784    PSTCO2                        N5PF.                               
      @789    PointOfOriginUB04             $CHAR1.                             
      @790    PointOfOrigin_X               $CHAR1.                             
      @791    PrimLang                      $CHAR3.                             
      @794    RACE                          N2PF.                               
      @796    RACE_X                        $CHAR2.                             
      @798    TOTCHG                        N10PF.                              
