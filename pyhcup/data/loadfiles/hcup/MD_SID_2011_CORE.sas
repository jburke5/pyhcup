...
INFILE 'MD_SID_2011_CORE.ASC' LRECL = 857;                                      
...
INPUT                                                                           
      ...
      @490    HCUP_ED                  N2PF.                                    
      @492    HCUP_OS                  N2PF.                                    
      @494    HCUP_SURGERY_BROAD       N2PF.                                    
      @496    HCUP_SURGERY_NARROW      N2PF.                                    
      @498    HISPANIC_X               $CHAR1.                                  
      @499    HOSPBRTH                 N3PF.                                    
      @502    HOSPST                   $CHAR2.                                  
      @504    HospitalUnit             N2PF.                                    
      @506    KEY                      18.                                      
      @524    LOS                      N5PF.                                    
      @529    LOS_X                    N6PF.                                    
      @535    MARITALSTATUSUB04        $CHAR1.                                  
      @536    MARITALSTATUS_X          $CHAR1.                                  
      @537    MDC                      N2PF.                                    
      @539    MDC24                    N2PF.                                    
      @541    MDC_NoPOA                N2PF.                                    
      @543    MDNUM1_R                 N9PF.                                    
      ...
      @607    PL_CBSA                  N3PF.                                    
      @610    PL_MSA1993               N3PF.                                    
      @613    PL_NCHS2006              N2PF.                                    
      @615    PL_RUCA10_2005           N2PF.                                    
      @617    PL_RUCA2005              N4P1F.                                   
      @621    PL_RUCA4_2005            N2PF.                                    
      @623    PL_RUCC2003              N2PF.                                    
      @625    PL_UIC2003               N2PF.                                    
      @627    PL_UR_CAT4               N2PF.                                    
      @629    PR1                      $CHAR4.                                  
      @633    PR2                      $CHAR4.                                  
