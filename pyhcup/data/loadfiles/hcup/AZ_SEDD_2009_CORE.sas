...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2009_CORE;                                                        
INFILE 'AZ_SEDD_2009_CORE.ASC' LRECL = 903;                                     
...
INPUT                                                                           
      ...
      @402    DXCCS24                  N4PF.                                    
      @406    DXCCS25                  N4PF.                                    
      @410    DX_Visit_Reason1         $CHAR5.                                  
      @415    DX_Visit_Reason2         $CHAR5.                                  
      @420    DX_Visit_Reason3         $CHAR5.                                  
      @425    ECODE1                   $CHAR5.                                  
      @430    ECODE2                   $CHAR5.                                  
      @435    ECODE3                   $CHAR5.                                  
      @440    ECODE4                   $CHAR5.                                  
      ...
      @590    PL_CBSA                  N3PF.                                    
      @593    PL_MSA1993               N3PF.                                    
      @596    PL_NCHS2006              N2PF.                                    
      @598    PL_RUCA10_2005           N2PF.                                    
      @600    PL_RUCA2005              N4P1F.                                   
      @604    PL_RUCA4_2005            N2PF.                                    
      @606    PL_RUCC2003              N2PF.                                    
      @608    PL_UIC2003               N2PF.                                    
      @610    PL_UR_CAT4               N2PF.                                    
      @612    PR1                      $CHAR4.                                  
      @616    PR2                      $CHAR4.                                  
      ...
      @759    PSTATE                   $CHAR2.                                  
      @761    PSTCO2                   N5PF.                                    
      @766    PointOfOriginUB04        $CHAR1.                                  
      @767    PointOfOrigin_X          $CHAR1.                                  
      @768    RACE                     N2PF.                                    
      @770    RACE_X                   $CHAR4.                                  
      @774    STATE_AS                 N2PF.                                    
      @776    STATE_ED                 N2PF.                                    
