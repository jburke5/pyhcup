...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SASDC_2010_CORE;                                                        
INFILE 'UT_SASD_2010_CORE.ASC' LRECL = 564;                                     
...
INPUT                                                                           
      ...
      @406    PL_CBSA                  N3PF.                                    
      @409    PL_MSA1993               N3PF.                                    
      @412    PL_NCHS2006              N2PF.                                    
      @414    PL_RUCA10_2005           N2PF.                                    
      @416    PL_RUCA2005              N4P1F.                                   
      @420    PL_RUCA4_2005            N2PF.                                    
      @422    PL_RUCC2003              N2PF.                                    
      @424    PL_UIC2003               N2PF.                                    
      @426    PL_UR_CAT4               N2PF.                                    
      @428    PR1                      $CHAR4.                                  
      @432    PR2                      $CHAR4.                                  
      ...
      @480    PSTCO                    N5PF.                                    
      @485    PSTCO2                   N5PF.                                    
      @490    PointOfOriginUB04        $CHAR1.                                  
      @491    PointOfOrigin_X          $CHAR1.                                  
      @492    STATE_AS                 N2PF.                                    
      @494    STATE_ED                 N2PF.                                    
      @496    STATE_OS                 N2PF.                                    
      @498    TOTCHG                   N10PF.                                   
