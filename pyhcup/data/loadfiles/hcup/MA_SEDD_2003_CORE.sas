...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2003_CORE;                                                        
INFILE 'MA_SEDD_2003_CORE.ASC' LRECL = 699;                                     
...
INPUT                                                                           
      ...
      @419    CPT78                    $CHAR5.                                  
      @424    CPT79                    $CHAR5.                                  
      @429    DaysBetweenVisits        N4PF.                                    
      @433    DHOUR                    N4PF.                                    
      @437    DIED                     N2PF.                                    
      @439    DISP_X                   $CHAR1.                                  
      @440    DISPUNIFORM              N2PF.                                    
      @442    DQTR                     N2PF.                                    
      @444    DSHOSPID                 $CHAR13.                                 
      @457    DX1                      $CHAR5.                                  
      @462    DX2                      $CHAR5.                                  
