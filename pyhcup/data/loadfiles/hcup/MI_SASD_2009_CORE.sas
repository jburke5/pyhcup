...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SASDC_2009_CORE;                                                        
INFILE 'MI_SASD_2009_CORE.ASC' LRECL = 1082;                                    
...
INPUT                                                                           
      ...
      @762    PL_CBSA                  N3PF.                                    
      @765    PL_MSA1993               N3PF.                                    
      @768    PL_NCHS2006              N2PF.                                    
      @770    PL_RUCA10_2005           N2PF.                                    
      @772    PL_RUCA2005              N4P1F.                                   
      @776    PL_RUCA4_2005            N2PF.                                    
      @778    PL_RUCC2003              N2PF.                                    
      @780    PL_UIC2003               N2PF.                                    
      @782    PL_UR_CAT4               N2PF.                                    
      @784    PR1                      $CHAR4.                                  
      @788    PR2                      $CHAR4.                                  
      ...
      @1002   PSTATE                   $CHAR2.                                  
      @1004   PSTCO2                   N5PF.                                    
      @1009   PointOfOriginUB04        $CHAR1.                                  
      @1010   PointOfOrigin_X          $CHAR1.                                  
      @1011   RACE                     N2PF.                                    
      @1013   RACE_X                   $CHAR1.                                  
      @1014   STATE_AS                 N2PF.                                    
      @1016   STATE_ED                 N2PF.                                    
