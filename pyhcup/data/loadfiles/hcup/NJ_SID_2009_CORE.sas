...
INFILE 'NJ_SID_2009_CORE.ASC' LRECL = 1425;                                     
...
INPUT                                                                           
      ...
      @873    PL_CBSA                  N3PF.                                    
      @876    PL_MSA1993               N3PF.                                    
      @879    PL_NCHS2006              N2PF.                                    
      @881    PL_RUCA10_2005           N2PF.                                    
      @883    PL_RUCA2005              N4P1F.                                   
      @887    PL_RUCA4_2005            N2PF.                                    
      @889    PL_RUCC2003              N2PF.                                    
      @891    PL_UIC2003               N2PF.                                    
      @893    PL_UR_CAT4               N2PF.                                    
      @895    PR1                      $CHAR4.                                  
      @899    PR2                      $CHAR4.                                  
      ...
      @1200   PSTCO                    N5PF.                                    
      @1205   PSTCO2                   N5PF.                                    
      @1210   PointOfOriginUB04        $CHAR1.                                  
      @1211   PointOfOrigin_X          $CHAR1.                                  
      @1212   PrimLang                 $CHAR3.                                  
      @1215   RACE                     N2PF.                                    
      @1217   RACE_X                   $CHAR5.                                  
      @1222   READMIT                  N2PF.                                    
      @1224   TOTCHG                   N10PF.                                   
      @1234   TOTCHG_X                 N15P2F.                                  
      @1249   TRAN_IN                  N2PF.                                    
      @1251   TRAN_OUT                 N2PF.                                    
      @1253   YEAR                     N4PF.                                    
      @1257   ZIP3                     $CHAR3.                                  
      @1260   ZIPINC_QRTL              N3PF.                                    
      @1263   TOWN                     $CHAR4.                                  
      @1267   ZIP                      $CHAR5.                                  
      @1272   AYEAR                    N4PF.                                    
      @1276   BMONTH                   N2PF.                                    
