...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SASDC_2011_CORE;                                                        
INFILE 'NE_SASD_2011_CORE.ASC' LRECL = 757;                                     
...
INPUT                                                                           
      ...
      @477    DXCCS8                   N4PF.                                    
      @481    DXCCS9                   N4PF.                                    
      @485    DX_Visit_Reason1         $CHAR5.                                  
      @490    DaysToEvent              N6PF.                                    
      @496    ECODE1                   $CHAR5.                                  
      @501    ECODE2                   $CHAR5.                                  
      @506    ECODE3                   $CHAR5.                                  
      @511    ECODE4                   $CHAR5.                                  
      ...
      @552    HCUP_ED                  N2PF.                                    
      @554    HCUP_OS                  N2PF.                                    
      @556    HCUP_SURGERY_BROAD       N2PF.                                    
      @558    HCUP_SURGERY_NARROW      N2PF.                                    
      @560    HOSPBRTH                 N3PF.                                    
      @563    HOSPST                   $CHAR2.                                  
      @565    KEY                      18.                                      
      @583    LOS                      N5PF.                                    
      @588    LOS_X                    N6PF.                                    
      @594    MARITALSTATUSUB04        $CHAR1.                                  
      @595    MARITALSTATUS_X          $CHAR1.                                  
      @596    MEDINCSTQ                N2PF.                                    
      @598    NCHRONIC                 N3PF.                                    
      @601    NCPT                     N3PF.                                    
      @604    NDX                      N2PF.                                    
      ...
      @630    PL_CBSA                  N3PF.                                    
      @633    PL_MSA1993               N3PF.                                    
      @636    PL_NCHS2006              N2PF.                                    
      @638    PL_RUCA10_2005           N2PF.                                    
      @640    PL_RUCA2005              N4P1F.                                   
      @644    PL_RUCA4_2005            N2PF.                                    
      @646    PL_RUCC2003              N2PF.                                    
      @648    PL_UIC2003               N2PF.                                    
      @650    PL_UR_CAT4               N2PF.                                    
      @652    PROCTYPE                 N3PF.                                    
      @655    PSTATE                   $CHAR2.                                  
      @657    PSTCO2                   N5PF.                                    
      @662    PointOfOriginUB04        $CHAR1.                                  
      @663    PointOfOrigin_X          $CHAR1.                                  
      @664    STATE_AS                 N2PF.                                    
      @666    STATE_ED                 N2PF.                                    
      @668    STATE_OS                 N2PF.                                    
      @670    TOTCHG                   N10PF.                                   
