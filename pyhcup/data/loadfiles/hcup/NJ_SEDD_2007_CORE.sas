...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2007_CORE;                                                        
INFILE 'NJ_SEDD_2007_CORE.ASC' LRECL = 556;                                     
...
INPUT                                                                           
      ...
      @419    PSTCO                    N5PF.                                    
      @424    PSTCO2                   N5PF.                                    
      @429    PointOfOriginUB04        $CHAR1.                                  
      @430    PointOfOrigin_X          $CHAR1.                                  
      @431    RACE                     N2PF.                                    
      @433    RACE_X                   $CHAR1.                                  
      @434    STATE_AS                 N2PF.                                    
      @436    STATE_ED                 N2PF.                                    
