...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2011_CORE;                                                        
INFILE 'MA_SEDD_2011_CORE.ASC' LRECL = 667;                                     
...
INPUT                                                                           
      ...
      @384    DXPOA5                   $CHAR1.                                  
      @385    DXPOA6                   $CHAR1.                                  
      @386    DaysBetweenVisits        N4PF.                                    
      @390    DaysToEvent              N6PF.                                    
      @396    ECODE1                   $CHAR5.                                  
      @401    ECODE2                   $CHAR5.                                  
      @406    ECODE3                   $CHAR5.                                  
      @411    ECODE4                   $CHAR5.                                  
      ...
      @458    HCUP_ED                  N2PF.                                    
      @460    HCUP_OS                  N2PF.                                    
      @462    HCUP_SURGERY_BROAD       N2PF.                                    
      @464    HCUP_SURGERY_NARROW      N2PF.                                    
      @466    HISPANIC_X               $CHAR15.                                 
      @481    HOSPBRTH                 N3PF.                                    
      @484    HOSPST                   $CHAR2.                                  
      @486    Homeless                 N2PF.                                    
      @488    KEY                      18.                                      
