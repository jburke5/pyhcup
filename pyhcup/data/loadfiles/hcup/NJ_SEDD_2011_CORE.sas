...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2011_CORE;                                                        
INFILE 'NJ_SEDD_2011_CORE.ASC' LRECL = 1324;                                    
...
INPUT                                                                           
      ...
      @1131   PSTCO                    N5PF.                                    
      @1136   PSTCO2                   N5PF.                                    
      @1141   PointOfOriginUB04        $CHAR1.                                  
      @1142   PointOfOrigin_X          $CHAR1.                                  
      @1143   PrimLang                 $CHAR3.                                  
      @1146   RACE                     N2PF.                                    
      @1148   RACE_X                   $CHAR5.                                  
      @1153   READMIT                  N2PF.                                    
      ...
      @1159   STATE_OS                 N2PF.                                    
      @1161   TOTCHG                   N10PF.                                   
      @1171   TOTCHG_X                 N15P2F.                                  
      @1186   YEAR                     N4PF.                                    
      @1190   ZIP3                     $CHAR3.                                  
      @1193   ZIPINC_QRTL              N3PF.                                    
      @1196   TOWN                     $CHAR4.                                  
      @1200   ZIP                      $CHAR5.                                  
      @1205   AYEAR                    N4PF.                                    
      @1209   DMONTH                   N2PF.                                    
