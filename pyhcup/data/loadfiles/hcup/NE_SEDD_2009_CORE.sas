...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2009_CORE;                                                        
INFILE 'NE_SEDD_2009_CORE.ASC' LRECL = 735;                                     
...
INPUT                                                                           
      ...
      @571    LOS                      N5PF.                                    
      @576    LOS_X                    N6PF.                                    
      @582    MARITALSTATUSUB04        $CHAR1.                                  
      @583    MARITALSTATUS_X          $CHAR1.                                  
      @584    MEDINCSTQ                N2PF.                                    
      @586    NCHRONIC                 N3PF.                                    
      @589    NCPT                     N3PF.                                    
      @592    NDX                      N2PF.                                    
      ...
      @608    PL_CBSA                  N3PF.                                    
      @611    PL_MSA1993               N3PF.                                    
      @614    PL_NCHS2006              N2PF.                                    
      @616    PL_RUCA10_2005           N2PF.                                    
      @618    PL_RUCA2005              N4P1F.                                   
      @622    PL_RUCA4_2005            N2PF.                                    
      @624    PL_RUCC2003              N2PF.                                    
      @626    PL_UIC2003               N2PF.                                    
      @628    PL_UR_CAT4               N2PF.                                    
      @630    PROCTYPE                 N3PF.                                    
      @633    PSTATE                   $CHAR2.                                  
      @635    PSTCO2                   N5PF.                                    
      @640    PointOfOriginUB04        $CHAR1.                                  
      @641    PointOfOrigin_X          $CHAR1.                                  
      @642    STATE_AS                 N2PF.                                    
      @644    STATE_ED                 N2PF.                                    
      @646    STATE_OS                 N2PF.                                    
      @648    TOTCHG                   N10PF.                                   
